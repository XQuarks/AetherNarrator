...
| **缓存优化** | System Prompt 硬化 + 前缀匹配加速，DeepSeek 缓存命中率优化至 75-90%+ |
| **流式输出** | SSE 流式 API，token 实时到达 + 进度显示，打字机效果逐字呈现 |
| **选项动画** | 选项在打字完成后从左至右缓动渐入，发送时立即消失，视觉流畅 |
| **体温可调** | 选项面板 0.0-1.0 滑块，默认 0.5（剧情模式，稳定连贯） |
| **AI 记忆** | 永久关键事实注入 + NPC 关系描述 + 叙事一致性自检，长对话不遗忘不矛盾 |
...
| 世界 | 类型 | 简介 |
|---|---|---|
| 蒸汽与魔法 | 原创 | 维多利亚蒸汽朋克，魔法被机械束缚 |
| 红楼梦 · 大观园 | 已有 IP | 清代贾府，儿女情长、家族兴衰，15 条知识库 + 8 位核心 NPC |
...
| `docs/07_示例_修仙世界.md` | 修仙世界观设定 |
| `docs/08_示例_哈利波特世界.md` | 哈利波特世界观设定 |
